globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///workspaces/okane/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file:///workspaces/okane/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///workspaces/okane/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///workspaces/okane/node_modules/devalue/index.js';
import { renderToString } from 'file:///workspaces/okane/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///workspaces/okane/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///workspaces/okane/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///workspaces/okane/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///workspaces/okane/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///workspaces/okane/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///workspaces/okane/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///workspaces/okane/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///workspaces/okane/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///workspaces/okane/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///workspaces/okane/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///workspaces/okane/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///workspaces/okane/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///workspaces/okane/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///workspaces/okane/node_modules/unified/index.js';
import { toString } from 'file:///workspaces/okane/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///workspaces/okane/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///workspaces/okane/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///workspaces/okane/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///workspaces/okane/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///workspaces/okane/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///workspaces/okane/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///workspaces/okane/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///workspaces/okane/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///workspaces/okane/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///workspaces/okane/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///workspaces/okane/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///workspaces/okane/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///workspaces/okane/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///workspaces/okane/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///workspaces/okane/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///workspaces/okane/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///workspaces/okane/node_modules/remark-rehype/index.js';
import { all } from 'file:///workspaces/okane/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///workspaces/okane/node_modules/detab/index.js';
import { u } from 'file:///workspaces/okane/node_modules/unist-builder/index.js';
import { encode } from 'file:///workspaces/okane/node_modules/mdurl/index.js';
import slugify from 'file:///workspaces/okane/node_modules/slugify/slugify.js';
import { position } from 'file:///workspaces/okane/node_modules/unist-util-position/index.js';
import { visit } from 'file:///workspaces/okane/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///workspaces/okane/node_modules/shiki-es/dist/shiki.node.mjs';
import { consola } from 'file:///workspaces/okane/node_modules/unenv/runtime/npm/consola.mjs';
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/Nuxt3Bootstrap5AppDemo/",
...
const serverAssets = [{"baseName":"server","dir":"/workspaces/okane/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/workspaces/okane/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/workspaces/okane/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspaces/okane","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspaces/okane/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspaces/okane/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspaces/okane/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///workspaces/okane/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _erFzkY = defineEventHandler(async (event) => {
...
const _Ln1y8H = defineEventHandler(async (event) => {
...
const _iyld2c = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_qHFgnq = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_qHFgnq, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _erFzkY, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _erFzkY, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _erFzkY, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _Ln1y8H, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _iyld2c, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _iyld2c, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _iyld2c, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_qHFgnq, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/workspaces/okane/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/workspaces/okane/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"stylesheet\" href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css\">\n<link rel=\"stylesheet\" href=\"https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.2/font/bootstrap-icons.css\">\n<script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js\"></script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
